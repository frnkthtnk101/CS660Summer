        ...
        #the spam threshold regulates the sensitivity of our classifier
            if spam_probability > spam_threshold:
                ...
                if classification == "ham":
                    ...
                    true_negatives += 1
        yield f"real hams {(true_positives/tests_counts)*100}", None
        yield f"fake hams {(true_negatives/tests_counts)*100}", None
        yield f"real spams {(false_positives/tests_counts)*100}", None
        yield f"fake spams {(false_negatives/tests_counts)*100}", None
